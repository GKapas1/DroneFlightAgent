  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x87, 0x38, 0xa9, 0xab, 0x25, 0xc3, 0xbe, 0x71,
      0x98, 0xc0, 0x30, 0xf7, 0xb8, 0xd1, 0x8a, 0x0d,
      0x5c, 0x3c, 0x52, 0x99, 0x02, 0x79, 0x4a, 0x58,
      0xcb, 0x67, 0x46, 0x34, 0x69, 0xc2, 0xbe, 0x06,
    }};
  return &hash;
}
...
static char px4__msg__EstimatorAidSource1d__FIELD_NAME__fusion_enabled[] = "fusion_enabled";
...
static rosidl_runtime_c__type_description__Field px4__msg__EstimatorAidSource1d__FIELDS[] = {
  ...
  {
    {px4__msg__EstimatorAidSource1d__FIELD_NAME__fusion_enabled, 14, 14},
    {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {px4__msg__EstimatorAidSource1d__FIELDS, 13, 13},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
