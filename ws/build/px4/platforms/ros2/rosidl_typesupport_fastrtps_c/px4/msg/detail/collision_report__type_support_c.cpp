...
bool cdr_serialize_px4__msg__CollisionReport(
  const px4__msg__CollisionReport * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
bool cdr_deserialize_px4__msg__CollisionReport(
  eprosima::fastcdr::Cdr & cdr,
  px4__msg__CollisionReport * ros_message)
{
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
bool cdr_serialize_key_px4__msg__CollisionReport(
  const px4__msg__CollisionReport * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: timestamp
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t get_serialized_size_key_px4__msg__CollisionReport(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CollisionReport__ros_msg_type * ros_message = static_cast<const _CollisionReport__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_key_px4__msg__CollisionReport(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const px4__msg__CollisionReport * ros_message = static_cast<const px4__msg__CollisionReport *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_px4__msg__CollisionReport(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  px4__msg__CollisionReport * ros_message = static_cast<px4__msg__CollisionReport *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_px4__msg__CollisionReport(cdr, ros_message);
}
